...
export type NavigationProps = typeof mapActionToProps & ReturnType<typeof mapStateToProps>;
                ...
                groups={[
                    {
                        name: 'Hero',
                        links:
                            Object.values(HeroClassType).map(type => ({
                                name: type,
